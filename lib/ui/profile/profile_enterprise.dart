...
class ProfileEnterprise extends StatefulWidget {
  ProfileEnterprise({Key key, this.profile, this.enterprise}) : super(key: key);

  final PersonModel profile;
  final EnterpriseModel enterprise;

  @override
  _ProfileEnterpriseState createState() => _ProfileEnterpriseState();
}
...
class _ProfileEnterpriseState extends State<ProfileEnterprise>
  ...
  //List<ProductListModel> _services = [];
  bool isLoading;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          Languages.of(context).profilecompany,
                          ...
                          background: Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                imageUrl: widget.enterprise?.image ?? '',
                                progressIndicatorBuilder: (_, __, ___) => _shimmer(width: 600.w, height: 400.w),
                                                  ...
                                                  children: [
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                              widget.enterprise.nbr_services.toString(),
                                                              style: GoogleFonts.cairo(
                                                                  fontSize:
                                                                      25.sp,
                                                                  fontWeight:
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                              widget.enterprise.nbr_rent.toString(),
                                                              style: GoogleFonts.cairo(
                                                                  fontSize: 25
                                                                      .sp,
                                                                  fontWeight:
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                              widget.enterprise.nbr_sell.toString(),
                                                              style: GoogleFonts.cairo(
                                                                  fontSize: 25
                                                                      .sp,
                                                                  fontWeight:
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                              widget.enterprise.nbr_request.toString(),
                                                              style: GoogleFonts.cairo(
                                                                  fontSize:
                                                                      25.sp,
                                                                  fontWeight:
                      ...
                      slivers: [
                        SliverPadding(
                          padding: EdgeInsets.only(
                              ...
                              left: .02.sw,
                              bottom: 0.1.sh),
                          sliver: _products.length <= 0 && _services.length <= 0
                              ? SliverList(
                              ...
                              : SliverStaggeredGrid.countBuilder(
                                  crossAxisCount: 2,
                                  itemCount: _isFetching ? 4 : listing_length,
                                    ...
                                    return _isFetching
                                        ...
                                        : listing_length > 0
                                            ? InkWell(
                                             ...
                                             child:(_profile.enterprise.type =="1")

                                                ? CardItem(
                                                    product: _products[index])

                                                :CardItemService(service: _services[index],
